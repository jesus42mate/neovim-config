...
See [Effective Neovim: Instant IDE](https://youtu.be/stqUbv-5u2s), covering the previous version. Note: The installation via init.lua is outdated, please follow the instructions in this file instead. An updated video is coming soon.
